...
- [Math Package](math.md) - Fixed-point scalar/vector helpers and AABB utilities
- [Physics Package](physics.md) - Deterministic rigid-body simulation and structural fracture helpers
- [Neon Package](neon.md) - Neon client networking protocol, transport, and plugin integration
- [Particles Package](particles.md) - Simulation particles, visual emitters, and render pass integration
- [Lighting Package](lighting.md) - Deferred lighting, shadows, and post-process pipeline
