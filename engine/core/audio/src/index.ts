...
export class AudioInstance {
  ...
  stop(): void {
    ...
    try {
      ...
      // Double-stop throws in some backends. This is not the hill to die on.
    }
...
/** WebAudio-style mixer with named buses and managed instances. */
...
/** Silent backend for servers/tests where audio output is unavailable. */
