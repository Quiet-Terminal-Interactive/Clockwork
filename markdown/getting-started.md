...
1. **Core runtime** (`qti-clockwork-app`, `qti-clockwork-ecs`, `qti-clockwork-scheduler`, `qti-clockwork-math`, `qti-clockwork-physics`, `qti-neon-client`, `qti-clockwork-particles`, `qti-clockwork-lighting`, etc.)
...
- [Math Package](math.md) for fixed-point math APIs and examples
- [Physics Package](physics.md) for rigid-body simulation APIs and examples
- [Neon Package](neon.md) for Neon networking APIs and examples
- [Particles Package](particles.md) for simulation/visual particle APIs and examples
- [Lighting Package](lighting.md) for deferred lighting APIs and examples
